    ...
    <div class="page">
      ...
      <div id="msaSection">
         ...
         <div class="form-row py-2">
          ...
          <div class="form-group col-md-6 px-4">
              <input type="email" name="email" id="emailInput" class="form-control" placeholder="Provide your email (optional)">
          </div>
      </div>
        <div class="form-row py-2 align-items-center">
         <div class="form-group col-md-6 px-4">
           <div class="custom-control custom-switch mt-2">
             <input type="checkbox" id="uniprotCode" name="uniprotCode" class="custom-control-input" checked>
             <label for="uniprotCode" class="custom-control-label text-dark">
               Map predictions on the AlphaFold 3D model for UniProt ID:
             </label>
           </div>
         </div>
      ...
      <script>
        document.addEventListener('DOMContentLoaded', function () {
          ...
          const customChainInput = document.getElementById('customChain');
          const pdbSection = document.getElementById('pdbSection');

          function toggleInputsAndSection() {
            if (uniprotCodeCheckbox.checked) {
              uniprotIdInput.setAttribute('required', 'required');
              customChainInput.removeAttribute('required');
          ...
          uniprotCodeCheckbox.addEventListener('change', toggleInputsAndSection);
          toggleInputsAndSection(); // Inicial
        });
      ...
      <div class="form-row py-2">
        ...
        <div class="form-group col-md-4 pl-1">
          <input type="text" id="customChain" name="customChain" class="form-control"
             placeholder="Please provide the chain: e.g. A">
        </div>
      </div>
      ...
      <div class="row py-3">
        <div class="col-12 d-flex justify-content-between px-7">
            <button type="submit" class="btn btn-primary example-button">Submit</button>
            <a href="{% url 'results' %}?q=job20250325123202" class="btn btn-primary example-button">Load an Example Protein</a>
        </div>
    </div>

       <div class="text-center">
          <img src="/static/browser/images/fig_search_server.png" id='panels' alt="mutLand" style="width: 100%; height: auto;margin-bottom: 50px;">
        </div></div>
