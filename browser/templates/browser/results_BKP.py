    ...
    <div class="container-fluid" style="width:95%;">
        <div class="row" style="display: flex; align-items: flex-start;">
            <div class="heatmap" style="flex: 1; autosize: true;">
                ...
                {% endif %}
                {% if not heatmap_html and not heatmapClasses_html %}
        ...
        if (pdbUrl1 && pdbUrl1 !== "undefined") {
            ...
            var options = {
                ...
                hideCanvasControls: ['selection', 'animation', 'controlToggle', 'controlInfo', 'controlZoom', 'controlRotate', 'controlTranslate', 'controlReset', 'controlFullscreen'],
                layoutIsExpanded: false,
                hideControls: true // This will hide the toolbar
            };
            ...
            function applyBFactorColoring() {
                viewerInstance.visual.setColor({
                    color: {
                      ...
                      params: {
                          list: [
                              { value: 30, color: { r: 0, g: 0, b: 255 } },   
                              { value: 40, color: { r: 255, g: 255, b: 255 } },
                              { value: 50, color: { r: 255, g: 0, b: 0 } }  
                          ],
                          min: 30,  
                          max: 50 
                      }
